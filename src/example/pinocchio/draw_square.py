...
def draw_square(reachy: ReachySDK) -> None:
    ...
    reachy.r_arm.goto(target_pose, duration=2.0, degrees=True, interpolation_space="cartesian_space")
...
def goto_to_point_A(reachy: ReachySDK) -> None:
    ...
    reachy.r_arm.goto(target_pose, duration=2, wait=True, interpolation_space="cartesian_space")
