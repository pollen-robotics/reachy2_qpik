...
class Reachy2QPIK:
    """Pinocchio-based Quadratic Programming Inverse Kinematics for Reachy2."""
    ...
    def __init__(
        ...
        """Initialize the PinocchioQPIK class.
        ...
        Args:
            ...
            locked_joints (list[str], optional): List of joints to lock before computation.
                If None, the default locked joints for the chosen arm will be used.
        """
    ...
    def default_locked_joints(self, arm: str) -> list[str]:
        """Get the default list of joints to lock.

        Args:
            arm (str): Arm to control ("l_arm" or "r_arm").

        Returns:
            list[str]: List of joint names to lock before computation.
        """
        shared_joints = [
            "tripod_joint",
            "l_hand_finger",
    ...
    def inverse_kinematics(
        ...
        Returns:
            tuple:
                - numpy.ndarray: Computed joint configuration (rad).
                - bool: True if convergence was reached.
    ...
    def compute_acceleration(
        ...
        Returns:
            numpy.ndarray: Joint accelerations (rad.s⁻²).
        """
        _, goal_pose, _ = self.is_pose_in_robot_reach(goal_pose)
